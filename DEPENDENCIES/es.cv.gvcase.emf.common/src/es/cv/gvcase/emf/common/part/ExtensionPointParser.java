...
/**
 * A basic simple {@link IExtensionPoint} parser. It parses an IExtensionPoint
 * and stores values in instances of the specified {@link Class}es specified. It
 * uses java reflection to get the elements and their attributes to parse. It
 * can handle {@link String}, {@link Boolean} and {@link Object} attributes. It
 * can handle any IExtensionPoint as long as the proper Classes are provided. <br>
 ...
 * <li>Each Class must have one attribute of type List for each type of child
 * element it can have as defined in the IExtensionPoint. The name of this List
 * attribute will be equal to the type of elements to be stored in it.</li>
 * <li>Use Boolean instead of boolean, this allows that field to be null,
 * indicating it has not been initialized.</li>
 * </ul>
 * <br>
 * The method {@link ExtensionPointParser#parseExtensionPoint()} will return a
 * {@link List} of Objects with a data structure similar to the one defined in
 * the IExtensionPoint.
 * 
...
public class ExtensionPointParser {
	...
	/**
	 * {@link Class}es from which create instances.
	 */
	private Class<Object>[] classes = null;

	/**
	 * Enclosing instance for internal {@link Class}es
	 */
	private Object enclosingInstance = null;

	/**
	 * {@link IExtensionPoint} full name identifier.
	 */
	private String extensionPointID = null;

	/**
	 * Constructor without enclosing {@link Class}.
	 * 
	...
	/**
	 * Constructor with enclosing {@link Class}.
	 * 
	 * @param extensionPointID
	 * @param classes
	...
	/**
	 * Parses the {@link IExtensionPoint} specified in the constructor. Returns
	 * a {@link List} of {@link Object} instances created from the {@link Class}
	 * es provided in the constructor. Fields with null value in the returned
	 * Objects have not been initialized, as those values were not specified in
	 * the IExtensionPoint.
	 * 
	 * @return
	 */
	public List<Object> parseExtensionPoint() {
		...
		if (extensionPoint == null) {
			Activator.getDefault().logError(
					"The Extension Point ID provided does not exist ["
							+ getExtensionPointID() + "]", null);
			return Collections.emptyList();
		}
	...
	/**
	 * Parse an {@link IConfigurationElement}, including its attributes and its
	 * children elements,
	 * 
	 * @param element
	 * @return
	...
	/**
	 * Gets an attribute from an {@link IConfigurationElement}.
	 * 
	 * @param element
	 * @param attribute
	 * @return
	...
	/**
	 * Adds children instances to the proper {@link List} attribute of the
	 * instance parent.
	 * 
	 * @param instance
	 * @param children
	...
	/**
	 * Creates an instance of an {@link Object} searching for the matching
	 * {@link Class} by simple name. The list of {@link Class}es to be used are
	 * provided in the constructor. Internal Classes must also provide an
	 * enclosing instance in the constructor.
	 * 
	 * @param element
	 * @return
	 */
