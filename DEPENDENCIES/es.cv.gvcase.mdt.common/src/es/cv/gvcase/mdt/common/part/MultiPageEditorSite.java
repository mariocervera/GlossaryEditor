 ...
 *     Francisco Javier Cano Muñoz (Prodevelop) - adapted for MOSKittMultiPageEditor.
 *******************************************************************************/
...
public class MultiPageEditorSite implements IEditorSite, INestable {
	 ...
	 */
	public String getId() {
		String editorID = getEditor() instanceof CachedResourcesDiagramEditor ? ((CachedResourcesDiagramEditor) getEditor())
				.getEditorID()
				: ""; //$NON-NLS-1$
		return editorID;
	}
	...
	public String getPluginId() {
		return "MultiPageEditorSitePluginID"; //$NON-NLS-1$
	}
	...
	public String getRegisteredName() {
		return "MultiPageEditorSiteRegisteredName"; //$NON-NLS-1$
	}
