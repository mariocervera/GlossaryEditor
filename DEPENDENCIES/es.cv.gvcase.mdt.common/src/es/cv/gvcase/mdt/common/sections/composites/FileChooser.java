...
public class FileChooser extends Composite {
	 ...
	 *            the filter extensions for the dialog
	 * @param style
	 */
	public FileChooser(Composite parent,
			TabbedPropertySheetWidgetFactory factory,
			String[] filterExtensions, int style) {
		this(parent, factory, style);
	...
	protected void createContents(Composite parent) {
		...
		field = widgetFactory.createText(parent,
				"", SWT.FLAT | SWT.BORDER | SWT.READ_ONLY); //$NON-NLS-1$
	...
	private boolean fileHasChanged(String oldFilePath, String newFilePath) {
		...
		if (oldFilePath == null && newFilePath == null || oldFilePath != null
