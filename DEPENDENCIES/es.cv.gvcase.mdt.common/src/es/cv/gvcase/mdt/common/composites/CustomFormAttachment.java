...
/**
 * A Custom Form Attachment to be used with Custom Form Data elements
 * 
 * @author mgil
 */
public class CustomFormAttachment {
	/**
	 ...
	 * @since 3.0
	 */
	public CustomFormAttachment(int numerator) {
	 ...
	 */
	public CustomFormAttachment(int numerator, int offset) {
	 ...
	 *            the offset of the side from the position
	 */
	public CustomFormAttachment(int numerator, int denominator, int offset) {
		if (denominator == 0)
	 ...
	 */
	public CustomFormAttachment(Control control) {
	 ...
	 */
	public CustomFormAttachment(Control control, int offset) {
	 ...
	 */
	public CustomFormAttachment(Control control, int offset, int alignment) {
		this.control = control;
		this.offset = offset;
		this.alignment = alignment;
	}

	CustomFormAttachment divide(int value) {
		return new CustomFormAttachment(numerator, denominator * value, offset
				/ value);
	}
	...
	CustomFormAttachment minus(CustomFormAttachment attachment) {
		CustomFormAttachment solution = new CustomFormAttachment();
	...
	CustomFormAttachment minus(int value) {
		return new CustomFormAttachment(numerator, denominator, offset - value);
	}

	CustomFormAttachment plus(CustomFormAttachment attachment) {
		CustomFormAttachment solution = new CustomFormAttachment();
		solution.numerator = numerator * attachment.denominator + denominator
				* attachment.numerator;
		solution.denominator = denominator * attachment.denominator;
	...
	CustomFormAttachment plus(int value) {
		return new CustomFormAttachment(numerator, denominator, offset + value);
	}
