...
public class DuplicateViewsCommand extends DuplicateEObjectsCommand {
	 ...
	 */
	public DuplicateViewsCommand(TransactionalEditingDomain editingDomain,
			String label, DuplicateRequest request, List viewsToDuplicate,
			Map duplicatedElements, Point offset) {
	...
	/**
	 * Assign semantic elements to all children of a view down the view tree
	 * hierarchy
	 * 
	 * @param view
	 *            the view tree hierarchy root
	 */
