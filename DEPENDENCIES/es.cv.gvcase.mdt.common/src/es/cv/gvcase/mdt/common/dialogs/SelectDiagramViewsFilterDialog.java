...
import es.cv.gvcase.mdt.common.provider.BaseViewInfoContentProvider;
import es.cv.gvcase.mdt.common.provider.BaseViewInfoLabelProvider;
...
public class SelectDiagramViewsFilterDialog extends Dialog {
	...
	protected Control createDialogArea(Composite parent) {
		getShell().setText(Messages.getString("SelectDiagramViewsFilterDialog.SelectViewsToFilter")); //$NON-NLS-1$
