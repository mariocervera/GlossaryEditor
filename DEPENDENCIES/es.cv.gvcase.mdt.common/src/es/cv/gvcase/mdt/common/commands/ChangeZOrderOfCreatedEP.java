...
public class ChangeZOrderOfCreatedEP extends AbstractTransactionalCommand {
	 ...
	 */
	public ChangeZOrderOfCreatedEP(TransactionalEditingDomain domain,
			ViewDescriptor descriptor, EditPartViewer viewer, String reqString) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (view == null) {
			return CommandResult
					.newErrorCommandResult("Element view not created");
		}
	...
	private Command getZOrderCommand(View view) {
		IGraphicalEditPart newElementEP = (IGraphicalEditPart) viewer
