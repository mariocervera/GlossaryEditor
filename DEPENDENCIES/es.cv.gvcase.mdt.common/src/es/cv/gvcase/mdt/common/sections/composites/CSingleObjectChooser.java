...
public class CSingleObjectChooser extends Composite {
	 ...
	 * @param style
	 */
	public CSingleObjectChooser(Composite parent,
			TabbedPropertySheetWidgetFactory factory, int style) {
		this(parent, factory, style, true);
	}
	...
	public CSingleObjectChooser(Composite parent,
		...
		this(parent, factory, style, singleSelection, null);
	}
	...
	protected void createContents(Composite parent) {
		...
		field = widgetFactory.createText(parent, "", SWT.FLAT | SWT.BORDER
				| SWT.READ_ONLY);
	...
	protected void handleChoose() {
		...
		ChooseDialog dialog = new ChooseDialog(getShell(), objects,
				isSingleSelection(), groupedTreeContentProvider);
	...
	public void setSection(
			AbstractTabbedPropertySection abstractTabbedPropertySection) {
