...
/**
 * A basic simple {@link IExtensionPoint} parser. It parses an IExtensionPoint and
 * stores values in instances of the specified {@link Class}es specified. It uses java
 * reflection to get the elements and their attributes to parse. It can handle
 * {@link String}, {@link Boolean} and {@link Object} attributes. It can handle any IExtensionPoint as
 ...
 * </ul>
 * <br>
 * The method {@link ExtensionPointParser#parseExtensionPoint()} will return a {@link List} of Objects with a data
...
public class ExtensionPointParser {
	...
	/**
	 * Parses the {@link IExtensionPoint} specified in the constructor. Returns a
	 * {@link List} of {@link Object} instances created from the {@link Class}es provided in the
	 * constructor. Fields with null value in the returned Objects have not
	...
	/**
	 * Adds children instances to the proper {@link List} attribute of the instance
	 * parent.
	 * 
	 * @param instance
	 * @param children
	...
	/**
	 * Creates an instance of an {@link Object} searching for the matching {@link Class} by
	 * simple name. The list of {@link Class}es to be used are provided in the
	 * constructor. Internal Classes must also provide an enclosing instance
	 * in the constructor.
	 * 
	 * @param element
	 * @return
