...
public class CSingleObjectChooser extends Composite {
	...
	private IStructuredContentProvider provider = new IStructuredContentProvider(){
	 ...
	 * @param style
	 */
	public CSingleObjectChooser(Composite parent, FormToolkit toolkit, int style) {
		super(parent, style);
	...
	protected void createContents(Composite parent) {
		...
		field = toolkit.createText(parent, "", SWT.FLAT | SWT.BORDER | SWT.READ_ONLY); //$NON-NLS-1$
	...
	protected void handleChoose() {
		ChooseDialog dialog = new ChooseDialog(getShell(), provider.getElements(new Object()));
	...
	public void setStructuredContentProvider(IStructuredContentProvider p){
		this.provider = p;
	}
