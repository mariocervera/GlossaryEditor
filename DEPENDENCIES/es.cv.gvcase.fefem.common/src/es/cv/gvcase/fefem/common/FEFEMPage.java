...
public abstract class FEFEMPage extends FormPage {
	...
	public Section createSection(final Composite parent, FormToolkit toolkit,
		...
		section.setText(text != null ? text : "");
		section.setLayoutData(new GridData(GridData.FILL_BOTH));

		return section;
	}

	public Section createTwistySection(final Composite parent, FormToolkit toolkit,
			String text, String description){
		Section section = null;

		if (description == null || description.equals("")) {
			section = toolkit.createSection(parent, Section.TWISTIE | Section.EXPANDED
					| Section.TITLE_BAR);
		} else {
			section = toolkit.createSection(parent, Section.TWISTIE | Section.EXPANDED
					| Section.TITLE_BAR | Section.DESCRIPTION);
