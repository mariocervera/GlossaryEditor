...
/**
 * An implementation of a composite with a multiline text field. Invoke
 * bindFeatureToWidget to bind the Text with the feature
 * 
 * @author Mario Cervera
 */
public abstract class EMFPropertyStringTextComposite extends
