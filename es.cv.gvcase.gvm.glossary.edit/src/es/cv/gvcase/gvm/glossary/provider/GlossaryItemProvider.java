...
/**
 * This is the item provider adapter for a {@link es.cv.gvcase.gvm.glossary.Glossary} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GlossaryItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Glossary_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Glossary_name_feature", "_UI_Glossary_type"),
				 GlossaryPackage.Literals.GLOSSARY__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(GlossaryPackage.Literals.GLOSSARY__CONTAINED_TERMS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(GlossaryPackage.Literals.GLOSSARY__CONTAINED_TERMS,
				 GlossaryFactory.eINSTANCE.createLocalTerm()));

		newChildDescriptors.add
			(createChildParameter
				(GlossaryPackage.Literals.GLOSSARY__CONTAINED_TERMS,
				 GlossaryFactory.eINSTANCE.createReferencedTerm()));

		newChildDescriptors.add
			(createChildParameter
				(GlossaryPackage.Literals.GLOSSARY__CONTAINED_TERMS,
				 GlossaryFactory.eINSTANCE.createRedefinedTerm()));
	}
