 ...
 * <ul>
 *   <li>{@link es.cv.gvcase.gvm.glossary.impl.TermImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class TermImpl extends MinimalEObjectImpl.Container implements Term {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GlossaryPackage.TERM__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GlossaryPackage.TERM__NAME:
				return getName();
		}
